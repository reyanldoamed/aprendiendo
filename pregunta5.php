...
<?php
    if(isset($_POST['radio'])){
        ...
        $urlnueva = "xls/preguntasalgrebra.xls";          
...
  <?php
        ...
        if(isset($_POST['radio'])){
            ...
            $objPHPExcel = PHPExcel_IOFactory::load('xls/preguntasalgrebra.xls');
            ...
            foreach ($objHoja as $iIndice=>$objCelda) {
                ...
                if($_POST['radio']=='s'){
                    ...
                    (id_p, id_ma, pregunta, op1, op2, op3, op4, respuesta) 
                        VALUES ('','5','$pregunta','$op1','$op2','$op3', '$op4','$respuesta')";
                        mysql_query($sql);
                }
                    }
            }
