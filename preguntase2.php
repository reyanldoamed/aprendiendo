...
//error_reporting(E_ALL ^ E_DEPRECATED);
 ...
 while($row = $retval->fetch_array()) {
  $q11 = $row['id_p'];
   ...
   $sql = "select * from preguntas where id_p!=$q11 and id_ma=3 ORDER BY rand()";
 ...
 while($row = $retval->fetch_array()){
  ...
  $sql = "select * from preguntas where id_p!=$q12 and id_p!=$q11 and id_ma=3 ORDER BY rand()";
 ...
 while($row = $retval->fetch_array()) {
  $q13 = $row['id_p'];
   ...
   $sql = "select * from preguntas where id_p!=$q13 and id_p!=$q12 and id_p!=$q11 and id_ma=3  ORDER BY rand()";
 ...
 while($row = $retval->fetch_array()){
  $q14 = $row['id_p'];
   ...
   $sql = "select * from  preguntas where id_p!=$q14 and id_p!=$q13  and id_p!=$q12 and id_p!=$q11 and id_ma=3 ORDER BY rand()";
