...
    </tbody>
 ...
 <form action="foto.php" method="POST" enctype="multipart/form-data">
            ...
            <td bgcolor="skyblue"><strong>SUBIR PREGUNTA:</strong></td>  <td><input type="file" name="foto" id="foto"></td>
               ...
               <tr bgcolor="skyblue">        
                <td><strong>RESPUESTA:</strong></td><td> 

               <select name="tipo" id="respuesta" name="respuesta">
          
                        
                        <option value="respuesta">a)</option>   
                        <option value="respuesta">b)</option>
                          <option value="respuesta">c)</option>   
                        <option value="respuesta">d)</option>
